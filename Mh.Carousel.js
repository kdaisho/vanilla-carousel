...
_Mh.Carousel = Class.create(_Mh.Base, {
    ...
    initialize: function ($super, config) {
        ...
        var _this = this
        this.__nextBtn &&
            this.__nextBtn.observe('click', function () {
        ...
        this.__prevBtn &&
            this.__prevBtn.observe('click', function () {
    ...
    __goto: function (index) {
        ...
        // an immediate position change, and then applying another position change with a transition "once it's finished".
    ...
    __onTouchStart: function (e) {
        if (this.__swipe || this.__lock === true) return
        this.__lock = true
    ...
    __inertia: function () {
        ...
        var g = gravity - this.__delta,
            ...
            accel
        if (false && dist > 20) {
            // Gravity doesn't hold a candle to a simple ease-in,
